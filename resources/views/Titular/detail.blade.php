    ...
    <div>
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">Modificado la ultima vez: {{ $titular->updated_at }}</small>
                </p>
            </div>
        </div>
        ...
        <div class="btn-group" role="group" aria-label="Basic outlined example">
            ...
            <a href="{{ route('titulares.index') }}" class="btn btn-secondary">Volver a la lista</a>
        </div>
    </div>
